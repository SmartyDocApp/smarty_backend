...
public class AuthentificationService {
    ...
    public TokenResponse login(LoginRequest loginRequest) {
        // Appel au user-service pour vérification via /api/users/login
        java.util.Map<String, String> loginMap = new java.util.HashMap<>();
        loginMap.put("email", loginRequest.getEmail());
        loginMap.put("password", loginRequest.getPassword());
        ResponseEntity<UserDto> userResponse = userServiceClient.loginUser(loginMap);
